  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <div className="flex space-x-2 items-center justify-center">
        <span className="text-sm text-muted-foreground text-center">{`https://whisper-me.vercel.app/send/${username}`}</span>
        <CopyIcon
          className="w-5 h-5 font-bold cursor-pointer hover:text-orange-500"
          onClick={() => handleCopy(`https://whisper-me.vercel.app/send/${username}`)}
        />
      </div>
    </div>
  );
